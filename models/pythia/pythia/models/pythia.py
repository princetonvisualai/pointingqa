...
class Pythia(BaseModel):
    ...
    def _init_feature_embeddings(self, attr):
        ...
        for _ in range(num_feature_feat):
            ...
            for feature_attn_model_params in feature_attn_model_list:
                ...
                print(feature_embedding.out_dim)
        ...
        print(self.feature_embeddings_out_dim)
        ...
        for i, feature in enumerate(features):
            ...
            for feature_embedding_model in feature_embedding_models:
                if context is not None:
                    inp = (encoded_feature, text_embedding_total, feature_dim, extra, context)
                else:
                    # extra = {"att": sample_list.att}
    ...
    def forward(self, sample_list):
        ...
        image_embedding_total, image_att = self.process_feature_embedding(
        ...
        model_output = {"scores": self.calculate_logits(joint_embedding), "att": image_att[0].squeeze()}
