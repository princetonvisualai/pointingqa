...
class TopDownAttention(nn.Module):
    ...
    def forward(self, image_feat, question_embedding, image_locs=None, context_embedding=None):
        
        # N x K x joint_dim
        if context_embedding is not None:
            joint_feature = self.combination_layer(image_feat, question_embedding, context_embedding)
        else:
